...
//---------------------------------------------------------------------------------------------------------------
    ...
    if(oJson["ip"]=="")
        AADD(aRetCampos,"Campo IP obrigat�rio.")
    EndIf

    if(oJson["porta"]=="")
        AADD(aRetCampos,"Campo porta obrigat�rio.")
    EndIf

    if(oJson["environment"]=="")
        AADD(aRetCampos,"Campo ambiente obrigat�rio.")
    EndIf

    if(oJson["listUsers"]=="")
        AADD(aRetCampos,"Campo se deseja listar usu�rios conectados obrigat�rio.")
    EndIf
